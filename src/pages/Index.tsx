			...
			<div className="p-2">
				<div className="bg-gradient-to-br from-[#43BE98]/10 to-emerald-400/5 rounded-lg p-6">
					...
					<Button
						...
						className={
							buttonText.includes("เริ่มสนทนา")
								? "w-full bg-[#43BE98] hover:bg-[#3aa988]"
								: "w-full border-[#43BE98] text-[#43BE98] hover:bg-[#43BE98]/10"
						}
					>
		...
		<div className="container mx-auto py-8 px-4">
			<section className="mb-12 lg:mb-20">
				...
				>
					...
					>
						ผู้ช่วยอัจฉริยะ{" "}
						<span className="text-[#43BE98]">อสังหาริมทรัพย์</span>
					</motion.h1>
